...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        self.transactions.append(Transaction(self.transaction_count, before, after))
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(self.transaction_count, before, before))
            self.transaction_count += 1
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        # return self.cents + (self.present_year - self.year)
